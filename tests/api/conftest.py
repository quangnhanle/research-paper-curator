...
async def client():
    ...
    with (
        ...
        patch("src.services.llm.factory.ExternalLLMClient") as mock_llm,
        patch("src.routers.ping.ExternalLLMClient") as mock_ping_llm,
        ...
        mock_ping_llm.return_value = AsyncMock()
