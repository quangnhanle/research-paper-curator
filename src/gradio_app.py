...
DEFAULT_MODEL = ""  # Empty means use the server-configured LLM model
...
async def stream_response(
    ...
    # Prepare request payload (omit model when blank so the server default is used)
    payload = {"query": query, "top_k": top_k, "use_hybrid": use_hybrid, "categories": category_list}
...
def create_gradio_interface():
    ...
    with gr.Blocks(
            ...
            with gr.Column():
                with gr.Accordion("Advanced Options", open=False):
                    ...
                    model_choice = gr.Textbox(
                        ...
                        placeholder="Leave empty to use the server-configured model",
                        info="Any model supported by the configured LLM provider, e.g. gpt-4o-mini",
                    )
        ...
        gr.Examples(
            examples=[
                ["What are transformers in machine learning?", 3, True, "", "cs.AI, cs.LG"],
                ["How do convolutional neural networks work?", 5, True, "", "cs.CV, cs.LG"],
                ["What is attention mechanism in deep learning?", 4, False, "", "cs.AI"],
                ["Explain reinforcement learning algorithms", 3, True, "", "cs.LG, cs.AI"],
                ["What are the latest developments in NLP?", 5, True, "", "cs.CL"],
            ],
